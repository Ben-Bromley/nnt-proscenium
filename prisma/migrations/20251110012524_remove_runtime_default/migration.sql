...
INSERT INTO "new_Performance" ("createdAt", "details", "externalBookingLink", "id", "intervalMinutes", "isActive", "maxCapacity", "reservationInstructions", "runtimeMinutes", "showId", "startDateTime", "title", "type", "updatedAt", "venueId") SELECT "createdAt", "details", "externalBookingLink", "id", "intervalMinutes", "isActive", "maxCapacity", "reservationInstructions", "runtimeMinutes", "showId", "startDateTime", "title", "type", "updatedAt", "venueId" FROM "Performance";
